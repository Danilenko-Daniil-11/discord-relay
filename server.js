...
const CATEGORY_MAX_CHILDREN = 50; // лимит Discord на канал в категории
const MAX_FILE_SIZE = 6 * 1024 * 1024; // 6MB guard для вложений (без Nitro)
...
let channelCacheByGuild = new Map();  // guildId -> { channelName::parentId -> channel }
...
function safeChannelName(prefix, id){
    // создаём короткое уникальное имя: pref-<hash>
